...
def main():
    ...
    if args.strict_prompt:
        query_prompt = (
            ...
            "First reason step by step under a '## Thinking' header, "
            "then write your conclusion under a '## Final Response' header. "
            "Your response MUST end with the phrase 'The answer is ' followed by "
            "ONE letter chosen from the options above (for example 'The answer is A.' "
            "or 'The answer is B.'). Do NOT write the literal word 'X' or leave a placeholder; "
            "you must commit to one of the actual option letters.\n"
            "{question}\n{option_str}"
        )
    else:
